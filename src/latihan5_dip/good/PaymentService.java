...
// High-level module yang DEPEND ON ABSTRACTIONS
...
public class PaymentService {
    ...
    // PENTING: Class ini harus:
    // 1. Depend on INTERFACES (abstractions), bukan concrete classes
    // 2. Receive dependencies via CONSTRUCTOR (Dependency Injection)
    // 3. Tidak create dependencies dengan 'new' di dalam class
